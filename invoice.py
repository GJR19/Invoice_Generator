...
def generate_invoice(customer_id, product_ids, quantities):
	...
	pdf.cell(200, 10, txt="GJR Technologies Pvt Ltd.", ln=True)
	pdf.cell(200, 10, txt="BLR, India", ln=True)
	pdf.cell(200, 10, txt="Pincode: 560064", ln=True)
	pdf.cell(200, 10, txt="Email: gjr@gmail.com", ln=True)
...
st.sidebar.header("Select The Customer And Products")
...
for product in selected_products:
	quantity = st.sidebar.number_input(f"Quantity of {product}", min_value=1, max_value=5, value=1)
